        ...
        <>
            <div className="container justify-content-center align-items-center text-center">
                <div className={`titulo_movil ${styles.titulo}`}>
                    <h4 className={`fw-bold ${styles.titulo}`}>BIOGRAFIA Y CRITICAS</h4>
                </div>
            </div>
            <div className=" bg-black ">
                <div className="container p-3" style={{ fontSize: "18px" }}>
                    <p >
                        Ya desde pequeño Álex (29/04/92) mostraba sus inquietudes musicales.<br></br>
                    ...
                    <p style={{ textAlign: 'justify' }}>
                        En 2017 da el gran salto musicales, lanzando su primer álbum <span style={{ color: "red" }}>"Trágico y fugaz"</span>, con buen recibimiento por parte de la crítica y público.
