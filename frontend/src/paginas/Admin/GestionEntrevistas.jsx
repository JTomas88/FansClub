...
export const GestionEntrevistas = () => {
    ...
    const eliminar_entrevista = async () => {

        try {
            const resultado = await actions.eliminarEntrevista(entrevistaAEliminar)
            console.log("Evento eliminado con éxito", resultado)
        } catch (error) {
    ...
    const abrirModalEditar = (entrevista) => {
        ...
        setTitular(entrevista.titular);
        setSubtitulo(entrevista.subtitulo);
        setCuerpo(entrevista.cuerpo);

        const imagenesArray = entrevista.imagen ? entrevista.imagen.split(",") : [];
                    ...
                    <div className="card" key={index} style={{ width: "18rem", backgroundColor: "PowderBlue" }}>
                        <div className="card-body">
                            ...
                            <div>
                                ...
                                <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modaleliminarentrevista" onClick={() => setEntrevistaAEliminar(entrevista.id)}>
                                    <MdOutlineDelete />
                                </button>
                                    ...
                                    <div className="modal-dialog">
                                        <div className="modal-content">
                                            ...
                                            <div className="modal-footer">
                                                ...
                                                <button type="button" data-bs-dismiss="modal" className="btn btn-primary" onClick={eliminar_entrevista}>Save changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
