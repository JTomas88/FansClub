...
export const Sorteos = () => {
    ...
    return (
        <>
            <Jumbotron imagenFondo={{ backgroundImage: `url(${jumbo_sorteos})`, backgroundPosition: 'center 20%' }} subtitulo={"Tal vez sólo hay sombras y formas"} referencia={'foto'} ></Jumbotron>
                        ...
                        >
                            ...
                            <div className="row mb-3">
                                <div className="col-6" style={{
                                    maxHeight: "400px", overflowY: "auto", overflowX: "hidden", paddingRight: '10px'
                                }}>
                                ...
                                <div className="col">
                                    ...
                                    {sorteo.sorImagen && sorteo.sorImagen.length > 0 ? (
                                        (() => {
                                            const imagenesSeparadas = sorteo.sorImagen.split(",").map(img => img.trim());;
                                                    ...
                                                    <div className="d-flex">
                                                        {imagenesSeparadas.map((img, imgIndex) => (
                                                            <img
                                                                ...
                                                                style={{ width: "48%", height: "auto", objectFit: "cover", borderRadius: "10px" }}
                                                            />
                                                        ))}
                                                    </div>
                                                );
                                ...
                                <button className={styles.flotante} >particpar</button>
                            </div>
